---
description: List this project's edge_case items
argument-hint: [--full|--short|--summary] [--json]
disable-model-invocation: true
---

List this project's **edge_case** items.

Run: `node "${CLAUDE_PLUGIN_ROOT}/src/cli/index.ts" list edge_case $ARGUMENTS`
