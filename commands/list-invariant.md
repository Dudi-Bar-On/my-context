---
description: List this project's invariant items
argument-hint: "[--full|--short|--summary] [--json]"
disable-model-invocation: true
---

List this project's **invariant** items.

Run: `node "${CLAUDE_PLUGIN_ROOT}/src/cli/index.ts" list invariant $ARGUMENTS`
