---
description: List this project's requirement items
argument-hint: "[--full|--short|--summary] [--json]"
disable-model-invocation: true
---

List this project's **requirement** items.

Run: `node "${CLAUDE_PLUGIN_ROOT}/src/cli/index.ts" list requirement $ARGUMENTS`
