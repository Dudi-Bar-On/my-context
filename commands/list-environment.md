---
description: List this project's environment items
argument-hint: "[--full|--short|--summary] [--json]"
disable-model-invocation: true
---

List this project's **environment** items.

Run: `node "${CLAUDE_PLUGIN_ROOT}/src/cli/index.ts" list environment $ARGUMENTS`
