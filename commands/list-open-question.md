---
description: List this project's open_question items
argument-hint: "[--full|--short|--summary] [--json]"
disable-model-invocation: true
---

List this project's **open_question** items.

Run: `node "${CLAUDE_PLUGIN_ROOT}/src/cli/index.ts" list open_question $ARGUMENTS`
