---
description: List this project's known_issue items
argument-hint: "[--full|--short|--summary] [--json]"
disable-model-invocation: true
---

List this project's **known_issue** items.

Run: `node "${CLAUDE_PLUGIN_ROOT}/src/cli/index.ts" list known_issue $ARGUMENTS`
