---
description: List this project's measurement items
argument-hint: "[--full|--short|--summary] [--json]"
disable-model-invocation: true
---

List this project's **measurement** items.

Run: `node "${CLAUDE_PLUGIN_ROOT}/src/cli/index.ts" list measurement $ARGUMENTS`
