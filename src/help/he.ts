...
export const HE_CATEGORY_DESCRIPTIONS: Record<string, string> = {
  ...
  exception: 'פטור תחום ומתוארך מפריט נורמטיבי מפורש בשמו, והנימוק שבגללו ניתן',
  contract: 'משטח שגורמים אחרים תלויים בו, ומה עולה לשנות אותו',
  ...
  measurement: 'מספר, כיצד הושג ומתי, כך שקורא עתידי יוכל להכריע אם הוא עדיין תקף',
  reference: 'תצלום מצב של קובץ, שמקורו מתועד כך ש-doctor מדווח על סחיפה',
  plan: 'גוף עבודה מוגדר בשם: המטרה שלו, הסדר שבו הוא נלקח, והתנאי שמסיים אותו',
  task: 'יחידת עבודה מתוכננת, שנעקבת עד להשלמתה. התוכנית, הרצף, המצב וההתקדמות חיים בשדות נוספים; הגוף הוא מה שהמשימה דורשת בפועל.',
