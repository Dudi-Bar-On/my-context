...
export const TIER_UPDATES: Record<Tier, CategoryUpdates> = {
  normative: {
    ...
    summary: { store: 'field', command: 'mycontext edit <id> --summary "…"', note: 'One plain sentence saying what this item IS and why it matters, for a reader who does NOT know this codebase - plain words, no ids, no paths, no numbers. Max 250 chars; the body keeps the precision. `--summary=` removes it.' },
