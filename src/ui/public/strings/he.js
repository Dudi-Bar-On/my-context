...
export const strings = {
  ...
  'sim.thresh': 'ספים',
  'sim.snap': 'כל ערך בין שתי מדרגות מתנהג באופן זהה, ולכן המחוון נצמד למדרגות — הגרירה נוחתת על משמעות ולא על {offrung}. מדרגה אדומה היא {b:פינוי}: יותר תקציב, פחות פריטים.',
  'sim.tier': 'רמה',
  'sim.budget': 'תקציב',
  'sim.fits': 'נכנס',
  'sim.spills': 'נשפך',
