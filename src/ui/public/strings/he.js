...
export const strings = {
  ...
  'preview.spec': 'הרצועה מחזיקה {b:דגימה} אחת לכל שער — הפריט הראשון לפי מזהה שנכשל בו — ולכן היא עומדת במקומה בזמן שהבחירה שלכם משתנה. כל פריט שנשפך באמת מופיע בשמו תחת {b:לא נמסר} למטה, בסדר שבו הבורר שקל אותו.',
  ...
  'work.h1': '{b:הריצו במעטפת שלכם.} הכלי הזה לעולם אינו כותב.',
  'work.h2': '{b:הקבלה:} רשומת ביקורת עם {m:op: promote-revision}.',
  ...
  // Procedures
  'pr.h': 'נהלים',
  'pr.sub': 'קבוצה מסודרת של צעדים המבוצעת {b:פעם אחת} ואז מסתיימת — בניגוד לכלל, שהוא הוראה אחת החלה בכל פעם. כלל הוא הוראה יחידה; נוהל הוא רצף. הוחלט; דבר עדיין אינו מממש זאת.',
  ...
  'title.unmeasured': 'משטח הקריאה אינו חושף צבירה על יומן הביקורת, ולכן הנתון אינו ידוע ולא אפס. רענון לא יעזור; קודם צריכה להיות נקודת קצה.',
  'title.gitState': 'לחצו כדי לעבור בין שבעת מצבי git שהמפרט דורש',
  ...
  'title.audit': 'לחצו כדי לעבור בין "נמדד" ל"לא נמדד" בנתוני הביקורת',
