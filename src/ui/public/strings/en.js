...
export const strings = {
  ...
  'conv.recall.fresh.hint': 'A result brought into this session competes with everything already in it — which is often the situation you are trying to escape. Into a cleared window it arrives into room. Run this to stage it; it is written to a file FIRST, so clearing cannot destroy it, and nothing is delivered until you approve it and clear the window yourself.',
  'conv.recall.fresh.copy': 'Copy the command',
  'conv.recall.fresh.then': 'It stages a proposal. Approving it is a separate act and it is yours, and so is the clear — there is no command for the clear anywhere in this product.',
