---
id: DEC-the-ask-screen-accepts-typed-sql-reversing-shown-never-typed
type: decision
title: the Ask screen accepts typed SQL, reversing 'shown, never typed'
status: active
severity: soft
always: false
summary: The question screen will let you write your own query, reversing an earlier choice to only show one, because the ready-made filters cannot ask what people need.
summary_of: a200600956767245
scope: []
tags:
  - v2
  - ui
...
valid_until: null
checksum: d6a242d8948caf55
---

# the Ask screen accepts typed SQL, reversing 'shown, never typed'
