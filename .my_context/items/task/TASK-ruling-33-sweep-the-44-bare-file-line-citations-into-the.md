...
- `isMainEntry` cited at `core/paths.ts:161`; it is at **187**.
- the `matchesAnyGlob` comment cited at `select.ts:127-129`; line 126 is `export function isEligible(` and 127-129 are its body. The comment is at **173**.
