...
Ruled 2026-09-22 at release checkpoint 2: the 2026-09-16 answer stands - both marks, no precedence - and the lane-report-wins half of ruling G is withdrawn; see DEC-a-turn-that-is-both-a-table-and-a-lane-report-carries-both. What remains here is the detector replacement (the lane report and the owner's own words as automatic marks) and the rebuild over the owner's archive, in release phase 7.
