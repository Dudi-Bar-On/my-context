...
severity: hard
always: false
summary: Whatever the check at the door approves has to be accepted further in, or a batch stops halfway and leaves things in a state no single part owns.
summary_of: a7b7f899412670c6
scope:
  - src/ingest/**
  - src/core/mutate.ts
