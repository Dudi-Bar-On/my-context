...
severity: soft
always: false
summary: Only the notes that tell you what to do are shown in full; the ones explaining past reasoning are merely counted, so the cost never grows with the pile.
summary_of: ad20ccccc011e02e
scope: []
tags:
  - architecture
origin: human
