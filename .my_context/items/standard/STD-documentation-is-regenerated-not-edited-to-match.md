...
severity: soft
always: false
summary: When example output in the documentation goes stale, re-run the command that produced it instead of editing the text until it agrees with the prose.
summary_of: 29b5bfa1420c9284
scope:
  - README.md
  - docs/README.he.md
