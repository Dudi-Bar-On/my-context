...
never renumbered, never reused, appended at the end. Until today nothing stored the mapping. The
numbers lived in conversation and in handover blocks, both of which are compacted or superseded, and
a few leaked into item bodies. A number that only exists in a chat message cannot be stable.

THIS ITEM IS THE MAP. When a D number is assigned, add it here in the same act.
...
proposed and are now in force, permanent like the rest:
  ...
  D32     Ask and Capture reviewed, not merged    plan:walk seq:141
  D33     the contradiction gate                  plan:contra seq:1-3
