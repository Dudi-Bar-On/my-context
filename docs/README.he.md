...
flowchart TB
  ...
  U --> CL["<b>mycontext …</b><br/>39 פקודות שורת פקודה"]
...
39 פקודות. `mycontext help` מדפיס את אותה רשימה מהתוכנית עצמה,
...
ל-14 מתוך 39 פקודות שורת הפקודה אין אחת, לכל אחת מסיבה שרשומה לידה
