...
אתה עובד על תהליך תשלום. אתה אומר ל-Claude: *מחירים הם מספר שלם של אגורות, אף פעם לא
שקלים בנקודה צפה — שגיאת העיגול בכל המרה היא הסיבה שהסכום הכולל לא התאים לשורות הפריטים
...
- **זה נודד.** כשמדביקים מהזיכרון, הכלל יוצא קצת אחרת בכל פעם. "אגורות שלמות" הופך
...
תבניות, מונחים, הוראות, לא-מטרות ושאלות פתוחות. *מחירים הם אגורות שלמות.* *לעולם אל
