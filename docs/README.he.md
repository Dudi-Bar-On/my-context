...
flowchart TB
  ...
  U --> CL["<b>mycontext …</b><br/>46 פקודות שורת פקודה"]
...
46 פקודות. `mycontext help` מדפיס את אותה רשימה מהתוכנית עצמה,
...
ל-17 מתוך 46 פקודות שורת הפקודה אין אחת, לכל אחת מסיבה שרשומה לידה
...
סדר. מתוכם, <span dir="ltr">`counts.test.ts`</span> מחשב מהתוכנית הרצה את היחס "17 מתוך 46
