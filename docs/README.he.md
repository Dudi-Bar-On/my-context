...
**המודל** קורא לעשרים וחמישה כלי ה-MCP. שני המשטחים קוראים וכותבים לאותם קובצי Markdown תחת
...
עשרים וחמישה כלים, מוגשים מעל stdio על ידי `src/mcp/server.ts`. המודל מגיע אליהם בלי shell, וכל
...
דרך פקודה. **הדרישה הזאת מקוימת היום, ונאכפת בבדיקה ולא בסקירה.** לכל אחד מעשרים וחמישה כלי
...
| **MCP** | Model Context Protocol — הממשק שדרכו Claude מגיע לכלים. my_context מגיש עשרים וחמישה מהם מעל stdio, והם המשטח היחיד של המודל אם אין לו shell |
