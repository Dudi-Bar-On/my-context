...
**הוא בן חלוף, והוא אינו חוזר.** השרת יוצא מעצמו אחרי שמונה שעות של חוסר פעילות כברירת מחדל
— <span dir="ltr">`--idle-ms`</span> מזיזה את זה לשני הכיוונים, עד תקרה של יממה — כאשר "חוסר
...
חייב הפעלה מחדש של השרת, וזו מטביעה אסימון חדש ומפנה את הישן ביותר משמונת ה-digests
