...
- <span dir="ltr">`lesson-accept`</span> ו-<span dir="ltr">`lesson-discard`</span> הן שער
  ...
  כדי לשמר.
- <span dir="ltr">`session`</span> היא טבלה שקוראים בטרמינל לפני שבוחרים סשן, ו-<span
  dir="ltr">`session name`</span> היא התווית שמצמידים אחרי שבחרו. אף אחד משני החצאים אינו של
  המודל: הרשימה עונה על שאלה שלמודל שרץ בתוך סשן אין, כי כבר יש לו את הסשן שהוא נמצא בו, ומתן
  השם מקבל מזהה שקוראים מתוך אותה רשימה, מפני ששום משטח של שורת הפקודה אינו מקבל מזהה כזה.
