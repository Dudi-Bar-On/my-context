...
flowchart TB
  ...
  U --> CL["<b>mycontext …</b><br/>48 פקודות שורת פקודה"]
...
48 פקודות. `mycontext help` מדפיס את אותה רשימה מהתוכנית עצמה,
...
ל-19 מתוך 48 פקודות שורת הפקודה אין אחת, לכל אחת מסיבה שרשומה לידה
...
סדר. מתוכם, <span dir="ltr">`counts.test.ts`</span> מחשב מהתוכנית הרצה את היחס "19 מתוך 48
