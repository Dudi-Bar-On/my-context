...
**המודל** קורא לעשרים ושניים כלי ה-MCP. שני המשטחים קוראים וכותבים לאותם קובצי Markdown תחת
...
עשרים ושניים כלים, מוגשים מעל stdio על ידי `src/mcp/server.ts`. המודל מגיע אליהם בלי shell, וכל
...
דרך פקודה. **הדרישה הזאת מקוימת היום, ונאכפת בבדיקה ולא בסקירה.** לכל אחד מעשרים ושניים כלי
...
| **MCP** | Model Context Protocol — הממשק שדרכו Claude מגיע לכלים. my_context מגיש עשרים ושניים מהם מעל stdio, והם המשטח היחיד של המודל אם אין לו shell |
