...
flowchart TB
  ...
  U --> CL["<b>mycontext …</b><br/>41 פקודות שורת פקודה"]
...
41 פקודות. `mycontext help` מדפיס את אותה רשימה מהתוכנית עצמה,
...
חמש-עשרה פקודות בשורת הפקודה משנות את מה ששולט בפרויקט הזה בלי אדם בלולאה. שמונה מהן מעבירות
...
| <span dir="ltr">`mycontext review discard-revision <id> --yes`</span> | דוחה רוויזיה ממתינה — <span dir="ltr">`--revision REV-...`</span> נדרש באותם תנאים כשיותר מאחת ממתינה. היא אינה משנה דבר במה ששולט, ולכן אינה נספרת בין החמש-עשרה שלמעלה — אבל היא מיישבת, סופית, הכרעה שתור הרוויזיות קיים כדי לשמור לאדם, ואותה הצעה אינה יכולה להיות מוחזקת שוב מול אותו טקסט. ההצעה עצמה נשארת ביומן |
...
ל-15 מתוך 41 פקודות שורת הפקודה אין אחת, לכל אחת מסיבה שרשומה לידה
...
סדר. מתוכם, <span dir="ltr">`counts.test.ts`</span> מחשב מהתוכנית הרצה את היחס "15 מתוך 41
