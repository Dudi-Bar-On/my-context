...
**המודל** קורא לעשרים ושישה כלי ה-MCP. שני המשטחים קוראים וכותבים לאותם קובצי Markdown תחת
...
עשרים ושישה כלים, מוגשים מעל stdio על ידי `src/mcp/server.ts`. המודל מגיע אליהם בלי shell, וכל
...
דרך פקודה. **הדרישה הזאת מקוימת היום, ונאכפת בבדיקה ולא בסקירה.** לכל אחד מעשרים ושישה כלי
...
| **MCP** | Model Context Protocol — הממשק שדרכו Claude מגיע לכלים. my_context מגיש עשרים ושישה מהם מעל stdio, והם המשטח היחיד של המודל אם אין לו shell |
