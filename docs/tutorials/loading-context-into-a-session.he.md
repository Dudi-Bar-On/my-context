...
**פקודת ה-slash היא המשטח.** <span dir="ltr">`/mycontext:LoadMyContext`</span> טוענת את הידע של הפרויקט
...
לפעולה חד-פעמית במקום קיבוע קבוע, <span dir="ltr">`mycontext carry <id>`</span> מסמן פריט אחד להזרקה
הבאה ואז שוכח אותו:
...
**מה שהשורה יודעת לעשות כאן והממשק לא.** כל מה שמשנה את מה שמגיע: <span dir="ltr">`pin`,
`unpin`</span> ו-`carry` הם פעולות טרמינל. הדפדפן מרכיב `pin` ו-`unpin` בקטלוג של מרכיב
